...
# Script to re-encode MKV files to MP4 with optimized quality settings
...
# Files to process (10 smallest)
files=(
    "Bourgeois Tagg - I Don't Mind At All (Video).mkv"
    "Muse • Hysteria (CC) 🎤 [Karaoke] [Instrumental Lyrics] (Video).mkv"
    "Santa Esmeralda - Don't Let Me Be Misunderstood (1977) • TopPop (Video).mkv"
    "ABBA - The Day Before You Came (Video).mkv"
    "PROCOL HARUM - A Whiter Shade Of Pale - promo film #1 (Official Video).mkv"
    "The Stranglers - Midnight Summer Dream (Video).mkv"
    "Indeep - Last Night A DJ Saved My Life (Official Music Video).mkv"
    "DJ Khaled - Out Here Grindin Clean (Video).mkv"
    "Herman's Hermits - No Milk Today (1966) (Video).mkv"
    "Muse - Hysteria (Karaoke Version) (Video).mkv"
)

echo "========================================="
echo "MKV to MP4 Re-encoding (Optimized)"
echo "========================================="
echo ""
...
echo "Summary:"
echo "========================================="
echo "✅ Re-encoded to MP4: $converted"
echo "❌ Failed: $failed"
echo ""
